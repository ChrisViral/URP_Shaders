Shader "NiksShaders/Rectangles"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                float square1 = (inRect(i.uv, float4(0.1, 0.1, 0.2, 0.2))) ? 1 : 0;
                float square2 = (inRect(i.uv, float4(0.5, 0.5, 0.3, 0.3))) ? 1 : 0;
                return float4(float3(1 ,1 ,0) * square1 + float3(0, 1, 0) * square2, 1);
            }
            ENDCG
        }
    }
